...
/* 🔴 22.9 — הפוך: הדפדפן כותב את היומן ל-Firestore מאז גל 3, ולכן
   הלקוח **קורא** אותו משם (מקור אחד; ממצא 32 + סגירת "שני מסכים,
   שתי אמיתות"). השרת עדיין אינו כותב אליו — הבדיקה שמעל נשארת. */
ok('ולכן הלקוח קורא אותו מ-Firestore (22.9)',
   /fsFirstRead\("gardenLog", true/.test(DS));
