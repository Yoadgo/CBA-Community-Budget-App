...
ok('שנים-עשר דגלים ברשימה', sandbox.FLAG_KEYS.length === 12, JSON.stringify(sandbox.FLAG_KEYS));
...
ok('flagsGet מחזירה מצב ורשימה', g.ok === true && g.keys.length === 12 && g.flags.servicesFromFirestore === true,
   JSON.stringify(g));
